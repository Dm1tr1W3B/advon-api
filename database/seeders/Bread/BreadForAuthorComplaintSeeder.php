...
class BreadForAuthorComplaintSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $dataRow = $this->dataRow($dataType, 'author_user_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'hidden',
        ...
        $dataRow = $this->dataRow($dataType, 'author_company_id');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type' => 'hidden',
        ...
        $dataRow->fill([
            ...
            'details' => [
                ...
                'type' => 'belongsToMany',
                'column' => 'advertisement_author_complaint_id',
                'key' => 'id',
                'label' => 'name',
                'pivot_table' => 'advertisement_author_complaint_type',
                'pivot' => '1',
                'taggable' => '0',
            ],
            'order' => 13,
