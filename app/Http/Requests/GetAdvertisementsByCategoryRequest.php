...
class GetAdvertisementsByCategoryRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'category_key' => 'required|string|max:254',
            ...
            'child_category_key' => 'nullable|string|max:254',
            'order' => ['nullable', Rule::in('price_asc', 'price_desc', 'popular_asc', 'popular_desc')],
