...
return [
    ...
    */
    ...
    'phone'                => 'Поле номера телефона  содержать от 11 до 13 символов',
    ...
    'identifier_cannot_be_less_than_0' => 'Идентификатор не может быть меньше 0',
    'invalid_value' => 'Неверное значение',
    'The number of hashtags cannot be more than 20' => 'Количество хештегов не может быть больше 20',
    ...
    */
    ...
    'attributes' => [
        ...
        'payment' => 'Оплата',
        'hashtags' => 'Хештеги',
        'reach_audience' => 'Охват',
        'travel_abroad' => 'Выезжаете ли за границу',
        'ready_for_political_advertising' => 'Готовы к политической рекламе',
        'photo_report' => 'Фотоотчет',
        'make_and_place_advertising' => 'Сами изготовите и разместите рекламу',
        ...
        'date_of_the' => 'Дата проведения',
        'date_start' => 'Дата начала',
        'date_finish' => 'Дата окончания',
        'is_agree' => 'Я соглашаюсь с правилами использования сервиса и передачей и обработкой моих данных',
        'advertisement_type' => 'Разместить как',
        'person_type' => 'Разместить как',
